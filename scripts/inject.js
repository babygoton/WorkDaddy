...
(function () {
  ...
  css.textContent = [
    ...
    '.wbs-session-usage-detail-row{min-height:32px;border-bottom:1px solid var(--wb-border-subtle,#eee);color:var(--wb-color-text-secondary,#5f6368);font-size:12px;font-variant-numeric:tabular-nums}',
